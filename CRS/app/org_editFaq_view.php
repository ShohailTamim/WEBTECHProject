								...
								<table>
									<tr>
										<td width="800">
											...
											<li><span><font color="white" size="5em" /><font color="Blue" size="6em" /><b>Question &nbsp ? 
											<textarea style="height:40px;width:700px;maxlength:90">
											
											</textarea></span><br>
											<font color="Green" size="6em" /><b>Answer &nbsp&nbsp&nbsp :
											<textarea style="height:60px;width:700px;maxlength:1200">
											...
											<button type="button" onclick="location.href='S_home.html'"><font color="red" size="4em" /><b/>Submit</button>
