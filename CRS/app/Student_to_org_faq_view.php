...
<head>
	<meta charset="UTF-8">
	<title>student to org faq</title>
</head>
<body>
...
<!--<tr align="left" >
			...
			<td valign="top" width="25%">
				...
				<br><br>
				<ul>
				     <span><a href="Student_to_org_about_view.php" style="text-decoration:none"><font color="teal" size="5em" />About</a></span>
					<hr width="150" align="left" size="5">
					<span><a href="Student_to_org_faq_view.php"style="text-decoration:none"><font color="teal" size="5em" />FAQ</a></span>
					<hr width="150" align="left" size="5">
