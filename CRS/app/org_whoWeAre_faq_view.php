...
<!--<tr align="left" >
			...
			<td valign="top" width="25%">
				...
				<br><br>
				<ul>
				    <span><a href="org_whoWeAre_view.php" style="text-decoration:none"><font color="teal" size="5em" />About</a></span>
					<hr width="150" align="left" size="5">
					<span><a href="org_whoWeAre_faq_view.php" style="text-decoration:none"><font color="teal" size="5em" />FAQ</a></span>
					<hr width="150" align="left" size="5">
